...
if __name__ == '__main__':
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):
        ...
        for i, data in enumerate(dataset):  # inner loop within one epoch
            ...
            #     a1, a2, a3, a4 = data['A'].shape
            #     data['A'] = data['A'].reshape((a1*a2, a3, a4)).unsqueeze(0)
            #     b1, b2, b3, b4 = data['B'].shape
            #     data['B'] = data['B']#[torch.randint(0,opt.batch_size,(1,)),:] # bs,3,b3,b4
            #     print('Aconcat:',data['A'].shape)
            #     print('Bconcat:',data['B'].shape)
            ...
            if total_iters % opt.display_freq == 0:   # display images on visdom and save images to a HTML file
                ...
                print('model_get_current_visuals:',model.get_current_visuals())
