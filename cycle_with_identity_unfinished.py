...
class CycleGAN3rdlossModel(BaseModel):
    """
    ...
    def forward(self):
        ...
        if self.skip==0:
            ...
            # fake_B: (1, 3, 256, 256) -> Fake beings
            # rec_A: (1, 15, 256, 256) -> Reconstructed tools
            # fake_A: (5, 15, 256, 256) -> Fake tools
            # rec_B: (5, 3, 256, 256) -> Reconstructed beings
    ...
    def backward_G(self):
        ...
        # print('Tensor shapes: Real_A = ', self.real_A.shape, 'Real_B = ', self.real_B.shape)
        # real_A: (1, 15, 256, 256) -> Tools
        # real_B: (5, 3, 256, 256) -> Tool beings
        ...
        if lambda_idt > 0:
            ...
            self.idt_A = self.netG_A(backprop_tensor_beings)
            ...
            self.idt_B = self.netG_B(backprop_tensor_tools)
