...
cd $pathToRepo
#wandb login myAPI
python train.py --dataroot ./datasets/collage_testing --name collage_test_cycle_gan_3rdloss_wandb --model cycle_gan_3rdloss --direction AtoB --dataset_mode unaligned  --use_wandb --continue_train --epoch_count 81
