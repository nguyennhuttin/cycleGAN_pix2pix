#!/bin/bash
#SBATCH --account=zd26
#SBATCH --job-name=cycle_gan_3rdloss
...
python train.py --dataroot ./datasets/collage_testing --name collage_test_cycle_gan_3rdloss --model cycle_gan_3rdloss --direction AtoB --dataset_mode unaligned #--use_wandb 
